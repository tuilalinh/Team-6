 ...
 * @author tp773
 */
public class CalculateWithMe_Ver2 extends javax.swing.JFrame {

    /**
     * Creates new form CalculateWithMe
     */
    public CalculateWithMe_Ver2() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        btnSquareA = new javax.swing.JButton();
        btnSquareB = new javax.swing.JButton();
        btnDeleteLeft = new javax.swing.JButton();
        btnDeleteRight = new javax.swing.JButton();
        btnCanA = new javax.swing.JButton();
        btnCanB = new javax.swing.JButton();
        ...
        btnSquareA.setBackground(new java.awt.Color(204, 0, 0));
        btnSquareA.setForeground(new java.awt.Color(255, 255, 255));
        btnSquareA.setText("a²");
        btnSquareA.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnSquareAActionPerformed(evt);
            }
        });

        btnSquareB.setBackground(new java.awt.Color(204, 0, 0));
        btnSquareB.setForeground(new java.awt.Color(255, 255, 255));
        btnSquareB.setText("b²");
        btnSquareB.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnSquareBActionPerformed(evt);
            }
        });

        btnDeleteLeft.setBackground(new java.awt.Color(0, 204, 51));
        btnDeleteLeft.setText("<-");
        btnDeleteLeft.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnDeleteLeftActionPerformed(evt);
            }
        });

        btnDeleteRight.setBackground(new java.awt.Color(0, 204, 51));
        btnDeleteRight.setText("->");
        btnDeleteRight.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnDeleteRightActionPerformed(evt);
            }
        });

        btnCanA.setBackground(new java.awt.Color(204, 0, 0));
        btnCanA.setForeground(new java.awt.Color(255, 255, 255));
        btnCanA.setText("√a");
        btnCanA.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnCanAActionPerformed(evt);
            }
        });

        btnCanB.setBackground(new java.awt.Color(204, 0, 0));
        btnCanB.setForeground(new java.awt.Color(255, 255, 255));
        btnCanB.setText("√b");
        btnCanB.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnCanBActionPerformed(evt);
            }
        });
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(31, 31, 31)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(btnSquareB, javax.swing.GroupLayout.PREFERRED_SIZE, 50, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(btnSquareA, javax.swing.GroupLayout.PREFERRED_SIZE, 1, Short.MAX_VALUE))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(btnCanA, javax.swing.GroupLayout.PREFERRED_SIZE, 45, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(btnCanB, javax.swing.GroupLayout.PREFERRED_SIZE, 1, Short.MAX_VALUE)))
                    .addGroup(layout.createSequentialGroup()
                        .addGap(115, 115, 115)
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addComponent(btnDeleteLeft, javax.swing.GroupLayout.PREFERRED_SIZE, 54, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(41, 41, 41)
                .addComponent(btnDeleteRight, javax.swing.GroupLayout.PREFERRED_SIZE, 58, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(20, 20, 20))
            .addGroup(layout.createSequentialGroup()
                .addGap(28, 28, 28)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(btnSquareA)
                    .addComponent(btnCanA))
                .addGap(18, 18, 18)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel3)
                    ...
                    .addComponent(btnSquareB)
                    .addComponent(btnCanB))
                .addGap(18, 18, 18)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                ...
                .addGap(18, 18, 18)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(btnDeleteLeft)
                    .addComponent(btnDeleteRight))
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CalculateWithMe_Ver2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CalculateWithMe_Ver2().setVisible(true);
            }
        });
    }

    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JButton btnCanA;
    private javax.swing.JButton btnCanB;
    private javax.swing.JButton btnChiadu;
    private javax.swing.JButton btnChianguyen;
    private javax.swing.JButton btnCong;
    private javax.swing.JButton btnDeleteLeft;
    private javax.swing.JButton btnDeleteRight;
    private javax.swing.JButton btnNhan;
    private javax.swing.JButton btnReset;
    private javax.swing.JButton btnSquareA;
    private javax.swing.JButton btnSquareB;
